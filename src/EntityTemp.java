...
//
//    public EntityTemp(EntityKind kind, String id, Point position, List<PImage> images, int resourceLimit, int resourceCount, double actionPeriod, double animationPeriod, int health, int healthLimit) {
//        this.kind = kind;
//        this.id = id;
...
//
//                Sapling sapling = Factory.createSapling(WorldLoader.SAPLING_KEY + "_" + fairyTarget.get().id, tgtPos, imageStore.getImageList(WorldLoader.SAPLING_KEY));
//
...
//            Person_Full dude = Factory.createPersonFull(id, position, actionPeriod, animationPeriod, resourceLimit, images);
//
...
//        Person_Searching dude = Factory.createPersonSearching(id, position, actionPeriod, animationPeriod, resourceLimit, images);
//
//        world.removeEntity(scheduler, this);
//
//        world.tryAddEntity(dude);
...
//            Tree tree = Factory.createTreeWithDefaults(WorldLoader.TREE_KEY + "_" + id, position, imageStore.getImageList(WorldLoader.TREE_KEY));
//
//            world.removeEntity(scheduler, this);
//
